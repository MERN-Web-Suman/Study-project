...
export default function Cards() {
  return (
    ...
    <div className='max-w-[1240px] mx-auto grid md:grid-cols-3 gap-8'>
        ...
        <div className='w-full hover:bg-gray-100 shadow-xl flex flex-col p-4 my-4 rounded-lg hover:scale-105 duration-300  '  >
        ...
        <div className='w-full shadow-xl  hover:bg-gray-100 flex flex-col p-4 md:my-0 my-8 rounded-lg hover:scale-105 duration-300'>
